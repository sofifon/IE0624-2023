...
/*	(void) console_getc(1); */
	...
	gfx_setCursor(15, 77);
	gfx_puts("Laboratorio 5");
	gfx_setCursor(15, 100);
	gfx_puts("Estudiante:");
	gfx_setCursor(15, 120);
	gfx_puts("Sofia Fonseca Munoz");
...
/*	(void) console_getc(1); */
	...
	while (samplesRead < numSamples) {
      ...
      // input tensor
      input->data.f[samplesRead * 6 + 3] = (gyr_x + 2000.0) / 4000.0;
      input->data.f[samplesRead * 6 + 4] = (gyr_y + 2000.0) / 4000.0;
      input->data.f[samplesRead * 6 + 5] = (gyr_z + 2000.0) / 4000.0;
